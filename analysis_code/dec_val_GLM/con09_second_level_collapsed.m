...
for cContrast = 1:length(cont_labels)
    ...
    % Output folder
    output_folder=[main_folder, '/outputs/group_level/connect/GLM_', class_label, '_collapsed_GMmask/', cont_label];
    ...
    for cSub = which_sub
        ...
        file_names{c,1}=[sufs.connect, 'GLM_', class_label, '_collapsed_GMmask/con_000', num2str(cContrast), '.nii'];
        c=c+1;
    end
