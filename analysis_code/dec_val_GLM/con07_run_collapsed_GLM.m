...
% function jacobs_GLM_SPM(which_sub)
which_sub=[1:5,7:9];
which_sub=19;
...
for cSub=which_sub
    ...
    load([sufs.connect, 'coll_dec_values_', class_label, '_run1.mat']);epi_run1=coPM;
    load([sufs.connect, 'coll_dec_values_', class_label, '_run2.mat']);epi_run2=coPM;
    load([sufs.connect, 'coll_dec_values_', class_label, '_run3.mat']);epi_run3=coPM;
    load([sufs.connect, 'coll_dec_values_', class_label, '_run4.mat']);epi_run4=coPM;

    %% Fun beggins (scanning parameters)
    matlabbatch{1}.spm.stats.fmri_spec.dir = {[sufs.connect, 'GLM_', class_label, '_collapsed_GMmask/']}; % Output folder
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).multi_reg = {[sufs.connect, 'coll_covar_dec_values_', class_label, '_run1.txt']};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(2).multi_reg = {[sufs.connect, 'coll_covar_dec_values_', class_label, '_run2.txt']};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(3).multi_reg = {[sufs.connect, 'coll_covar_dec_values_', class_label, '_run3.txt']};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(4).multi_reg = {[sufs.connect, 'coll_covar_dec_values_', class_label, '_run4.txt']};
